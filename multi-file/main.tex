...
\newcommand{\Supervisor}{DSc Anna Gorawska}  % supervisor (remove $\langle$ and $\rangle)
...
\newcommand{\Departament}{Departament of Applied Computer Science} % your supervisor's departament  (remove $\langle$ and $\rangle)
